...
public class StubUpdateShardOperation extends UpdateShardOperation {
  ...
  /**
   * Sets the stub of UpdateShardOperation.handleUndoGlobalPostLocalExecuteError(StoreResults
   * result)
   */
   ...
   */
  public StubUpdateShardOperation(ShardMapManager shardMapManager, StoreShardMap shardMap,
