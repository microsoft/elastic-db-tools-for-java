...
public class StubRemoveShardOperation extends RemoveShardOperation {
   ...
   */
  public Action1Param<StoreResults>
      doGlobalPostLocalUpdateCacheIStoreResults;
  /**
  ...
  /**
   * Sets the stub of RemoveShardOperation.handleUndoGlobalPostLocalExecuteError(StoreResults
   * result)
   */
   ...
   */
  public StubRemoveShardOperation(ShardMapManager shardMapManager, StoreShardMap shardMap,
      StoreShard shard) {
