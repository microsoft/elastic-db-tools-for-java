...
public class RemoveShardingSchemaInfoGlobalOperation extends StoreOperationGlobal {
     ...
     */
    public RemoveShardingSchemaInfoGlobalOperation(ShardMapManager shardMapManager, String operationName, String schemaInfoName) {
    ...
    public StoreResults DoGlobalExecute(IStoreTransactionScope ts) {
        return ts.ExecuteOperation(StoreOperationRequestBuilder.SpRemoveShardingSchemaInfoGlobal, StoreOperationRequestBuilder.RemoveShardingSchemaInfoGlobal(_schemaInfoName));
    }
    ...
    public void HandleDoGlobalExecuteError(StoreResults result) {
        ...
        throw StoreOperationErrorHandler.OnShardSchemaInfoErrorGlobal(result, _schemaInfoName, this.getOperationName(), StoreOperationRequestBuilder.SpRemoveShardingSchemaInfoGlobal);
    }
