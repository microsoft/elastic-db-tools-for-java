...
public class FindShardByLocationGlobalOperation extends StoreOperationGlobal {
    ...
    public void HandleDoGlobalExecuteError(StoreResults result) {
        ...
        throw StoreOperationErrorHandler.OnShardMapErrorGlobal(result, _shardMap, null, ShardManagementErrorCategory.ShardMap, this.getOperationName(), StoreOperationRequestBuilder.SpFindShardByLocationGlobal); // shard
    }
