...
public class ReferenceTableInfo extends TableInfo implements Serializable {
     ...
     * @return true if the specified ReferenceTableInfo object is equal to the current object; otherwise, false.
     */
    public final boolean equals(ReferenceTableInfo other) {
        ...
        return this.getSchemaName().equals(other.getSchemaName()) && this.getTableName().equals(other.getTableName());
    }
