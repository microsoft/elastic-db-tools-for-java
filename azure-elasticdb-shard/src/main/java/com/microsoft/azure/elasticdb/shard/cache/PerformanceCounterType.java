...
/**
 * Summary:
 * Specifies the formula used to calculate the System.Diagnostics.PerformanceCounter.NextValue
 * method for a System.Diagnostics.PerformanceCounter instance.
 */
public enum PerformanceCounterType {
   ...
   * type except that is uses larger fields to accommodate larger values.
   */
  ...
  RawBase(1073939459),
  /**
   * Summary: A base counter that indicates the number of items sampled. It is used as the
   * denominator in the calculations to get an average among the items sampled when taking timings
   * of multiple, but similar items. Used with CounterMultiTimer, CounterMultiTimerInverse,
  ...
  private static java.util.HashMap<Integer, PerformanceCounterType> getMappings() {
    if (mappings == null) {
