...
public final class ShardLocation implements Serializable {
  ...
  /**
   * Constructor that allows specification of protocol, address, port and database to identify a
   * shard.
   *
   ...
   * @param port Port number for TCP/IP connections. Specify 0 to use the default port for the
   * specified <paramref name="protocol"/>.
   */
  ...
  private int CalculateHashCode() {
    ...
    h = ShardKey.qpHash(this.getProtocol().hashCode(),
        this.getDataSource().toUpperCase(Locale.ROOT).hashCode());
