...
public class Errors {
  ...
  public static String _Recovery_ShardNotValid = "The given location '%1$s' does not have the"
      + " necessary storage structures present for a shard. Error occurred while performing"
      + " operation '%2$s'.";
  ...
  public static String _ShardKey_MaxValueCannotBeRepresented = "Shard key has maximum value which"
      + " cannot be represented. Perform the IsMax check on shard key before requesting a"
      + " conversion.";
  public static String _ShardKey_RequestedTypeDoesNotMatchShardKeyType = "The requested type '%1$s'"
      + " does not match the shard key type '%2$s'.";
  ...
  public static String _ShardKey_UnsupportedShardKeyType = "The specified ShardKeyType specified is"
      + " not supported. ";
  public static String _ShardKey_UnsupportedType = "Type not supported for shard keys.";
  public static String _ShardKey_UnsupportedValue = "The given value is of type '%1$s' which is an"
      + " unsupported shard key type.";
  ...
  public static String _ShardKey_ValueLengthUnexpected = "The length of raw value specified for"
      + " the shard key (%1$s bytes) does not match the expected length (%2$s bytes) for the"
      + " ShardKeyType (%3$s) specified.";
  ...
  public static String _ShardLocation_UnsupportedProtocol = "The given protocol value '%1$s' is not"
      + " supported.";
  ...
  public static String _ShardMap_OpenConnectionForKey_KeyTypeNotSupported = "Key values of type"
      + " '%1$s' are not supported. OpenConnectionForKey requests for the shard map '%2$s'"
      + " requires keys of type '%3$s'.";
  public static String _ShardMapExtensions_AsTypedShardMap_ConversionFailure = "Shard map '%1$s'"
      + " can not be converted to the target type %2$sShardMap<%3$s>. Its actual type is"
      + " %4$sShardMap<%5$s>.";
  ...
  public static String _ShardMapManager_ShardMapLookupFailed = "Shard map '%1$s' could not be"
      + " found in the shard map manager store at '%2$s'.";
  ...
  public static String _ShardMapping_RangeNotSubset = "Requested range is not a subset of the"
      + " existing range mapping.";
  public static String _ShardMapping_SplitPointOutOfRange = "Split point lies on the boundary or"
      + " outside of the specified range mapping.";
  ...
  public static String _Store_Shard_AlreadyExistsGlobal = "Shard '%1$s' already exists in store"
      ...
      + " operation '%4$s'. This can happen when another concurrent user adds the shard to the"
      + " store.";
  ...
  public static String _Store_ShardMap_AlreadyExistsGlobal = "Shard map with name '%1$s' already"
      + " exists in the store. Error occurred while executing stored procedure '%2$s' for"
      + " operation '%3$s'.";
  ...
  public static String _Store_ShardMapper_MappingDoesNotExistGlobal = "Mapping referencing shard"
      ...
      + " procedure '%3$s' for operation '%4$s'. This can occur if another concurrent user has"
      + " already removed the mapping.";
  ...
  public static String _Store_ShardMapper_MappingPointOrRangeAlreadyMapped = "Mapping referencing"
      ...
      + " '%4$s' for operation '%5$s'. This can occur if another concurrent user has already added"
      + " a mapping covering the given %3$s.";
  ...
  public static String _Store_SqlOperation_LockNotAcquired = "Exclusive access to application"
      + " resource '%1$s' could not be acquired.";
  public static String _Store_SqlOperation_LockNotReleased = "Exclusive access to application"
      + " resource '%1$s' could not be released.";
  public static String _Store_StoreException = "Error occurred while performing store operation."
      + " See the inner SqlException for details.";
  public static String _Store_UnexpectedErrorGlobal = "Unexpected error code found while processing"
      + " errors returned from the shard map manager store. This can occur because of a defect in"
      + " the client library.";
  public static String _Store_UnexpectedErrorLocal = "Unexpected error code found while processing"
      + " errors returned from the shard location '%1$s'. This can occur because of a defect in the"
      + " client library.";
  public static String _Store_UnsupportedLibraryVersionGlobal = "Shard map manager store version"
      + " '%1$s' is not compatible with the version '%2$s' supported by client library. Please"
      + " upgrade the %3$s.";
  public static String _Store_UnsupportedLibraryVersionLocal = "Shard map manager store version"
      + " '%1$s' at shard '%2$s' is not compatible with the version '%3$s' supported by client"
      + " library. Please upgrade the %4$s.";
  ...
  public static String _Store_Validate_ShardDoesNotExist = "Shard '%1$s' belonging to shard map"
      ...
      + " for operation '%4$s' on the shard. This can happen if another concurrent user deletes"
      + " the shard. ";
  public static String _Store_Validate_ShardMapDoesNotExist = "Shard map '%1$s' associated with"
      ...
      + " '%3$s' for operation '%4$s'. This can happen if another concurrent user deletes"
      + " the shard map.";
