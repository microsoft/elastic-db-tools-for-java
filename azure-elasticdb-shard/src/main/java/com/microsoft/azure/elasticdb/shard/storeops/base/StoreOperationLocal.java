...
public abstract class StoreOperationLocal implements IStoreOperationLocal {
     ...
     */
    public StoreOperationLocal(SqlShardMapManagerCredentials credentials, RetryPolicy retryPolicy, ShardLocation location, String operationName) {
    ...
    private IStoreTransactionScope GetTransactionScope() {
        return _localConnection.GetTransactionScope(this.getReadOnly() ? StoreTransactionScopeKind.ReadOnly : StoreTransactionScopeKind.ReadWrite);
    }
