...
/**
 * Provides the transient error detection logic for transient faults that are specific to Shard map
 * manager.
 */
public final class ShardManagementTransientErrorDetectionStrategy implements
