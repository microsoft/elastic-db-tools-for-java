...
public class GlobalConstants {
   ...
   */
  public static final String ShardMapManagerPrefix =
      "ESC_SMMv" + ShardManagementVersionInfo + "_User";
  /**
   * ShardMapManager ApplicationName for Storage connections.
   */
  public static final String ShardMapManagerInternalConnectionSuffixGlobal =
      "ESC_SMMv" + ShardManagementVersionInfo + "_GSM";
  /**
   * ShardMapManager ApplicationName for Storage connections.
   */
  public static final String ShardMapManagerInternalConnectionSuffixLocal =
      "ESC_SMMv" + ShardManagementVersionInfo + "_LSM";
}