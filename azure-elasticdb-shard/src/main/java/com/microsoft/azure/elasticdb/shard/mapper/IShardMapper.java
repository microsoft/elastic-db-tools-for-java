...
public interface IShardMapper<TMapping extends IShardProvider, TValue> {
     ...
     */
    SQLServerConnection OpenConnectionForKey(TValue key, String connectionString, ConnectionOptions options);
     ...
     * @return An opened SqlConnection.
     */
    Callable<SQLServerConnection> OpenConnectionForKeyAsync(TValue key, String connectionString, ConnectionOptions options);
