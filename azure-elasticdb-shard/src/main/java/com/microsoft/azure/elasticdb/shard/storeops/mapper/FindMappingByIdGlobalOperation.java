...
public class FindMappingByIdGlobalOperation extends StoreOperationGlobal {
    ...
    public void HandleDoGlobalExecuteError(IStoreResults result) {
        ...
        throw StoreOperationErrorHandler.OnShardMapperErrorGlobal(result, _shardMap, _mapping.getStoreShard(), _errorCategory, this.getOperationName(), StoreOperationRequestBuilder.SpFindShardMappingByIdGlobal); // shard
    }
