...
public class FindShardingSchemaInfoGlobalOperation extends StoreOperationGlobal {
     ...
     */
    public FindShardingSchemaInfoGlobalOperation(ShardMapManager shardMapManager, String operationName, String schemaInfoName) {
    ...
    public void HandleDoGlobalExecuteError(StoreResults result) {
        ...
        if (result.getResult() != StoreResult.SchemaInfoNameDoesNotExist) {
            ...
            throw StoreOperationErrorHandler.OnShardSchemaInfoErrorGlobal(result, _schemaInfoName, this.getOperationName(), StoreOperationRequestBuilder.SpFindShardingSchemaInfoByNameGlobal);
        }
    }
