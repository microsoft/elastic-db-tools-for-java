...
public class DetachShardGlobalOperation extends StoreOperationGlobal {
     ...
     */
    public DetachShardGlobalOperation(ShardMapManager shardMapManager, String operationName, ShardLocation location, String shardMapName) {
    ...
    public StoreResults DoGlobalExecute(IStoreTransactionScope ts) {
        return ts.ExecuteOperation(StoreOperationRequestBuilder.SpDetachShardGlobal, StoreOperationRequestBuilder.DetachShardGlobal(_shardMapName, _location));
    }
    ...
    public void HandleDoGlobalExecuteError(StoreResults result) {
        ...
        throw StoreOperationErrorHandler.OnRecoveryErrorGlobal(result, null, null, ShardManagementErrorCategory.Recovery, this.getOperationName(), StoreOperationRequestBuilder.SpDetachShardGlobal);
    }
