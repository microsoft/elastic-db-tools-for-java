...
AS
  BEGIN
    ...
    IF (
      @gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @operationId IS NULL OR
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @name IS NULL OR
        @schemaInfo IS NULL)
      GOTO Error_MissingParameters;
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @protocol IS NULL OR
        @serverName IS NULL OR
...
AS
  BEGIN
    ...
    IF (
      @gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @removeStepsCount IS NULL
      OR
