...
ALTER TABLE __ShardManagement.ShardMapManagerGlobal
  ADD CONSTRAINT pkShardMapManagerGlobal_StoreVersionMajor PRIMARY KEY (StoreVersionMajor)
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @operationId IS NULL OR
        @undoStartState IS NULL)
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @shardMapId IS NULL OR @name IS NULL OR
        @mapType IS NULL OR @keyType IS NULL)
      GOTO Error_MissingParameters;
...
AS
  BEGIN
    ...
    IF (
      @gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @operationId IS NULL OR @operationCode IS NULL
      OR
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @shardMapId IS NULL OR @name IS NULL OR
        @mapType IS NULL OR @keyType IS NULL OR
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @protocol IS NULL OR @serverName IS NULL OR
        @port IS NULL OR @databaseName IS NULL)
      GOTO Error_MissingParameters;
...
AS
  BEGIN
    ...
    IF (@gsmVersionMajorClient IS NULL OR @gsmVersionMinorClient IS NULL OR @removeStepsCount IS NULL OR
        @addStepsCount IS NULL OR @shardMapId IS NULL)
      GOTO Error_MissingParameters;
