...
public class GetShardMapsGlobalOperation extends StoreOperationGlobal {
     ...
     */
    public GetShardMapsGlobalOperation(ShardMapManager shardMapManager,
    ...
    public StoreResults doGlobalExecute(IStoreTransactionScope ts) {
        return ts.executeOperation(StoreOperationRequestBuilder.SP_GET_ALL_SHARD_MAPS_GLOBAL, StoreOperationRequestBuilder.getAllShardMapsGlobal());
    }
