...
public class GetShardsLocalOperation extends StoreOperationLocal {
     ...
     *            Operation name.
     */
    public GetShardsLocalOperation(ShardMapManager shardMapManager,
    ...
    public StoreResults doLocalExecute(IStoreTransactionScope ts) {
        ...
        return ts.executeOperation(StoreOperationRequestBuilder.SP_GET_ALL_SHARDS_LOCAL, StoreOperationRequestBuilder.getAllShardsLocal());
    }
    ...
    public void handleDoLocalExecuteError(StoreResults result) {
        ...
        throw StoreOperationErrorHandler.onRecoveryErrorLocal(result, null, this.getLocation(), ShardManagementErrorCategory.Recovery,
                this.getOperationName(), StoreOperationRequestBuilder.SP_GET_ALL_SHARDS_LOCAL);
    }
}