...
public class GetMappingsByRangeGlobalOperation extends StoreOperationGlobal {
     ...
     */
    public GetMappingsByRangeGlobalOperation(ShardMapManager shardMapManager,
    ...
    public void handleDoGlobalExecuteError(StoreResults result) {
        ...
        if (!ignoreFailure || result.getResult() != StoreResult.ShardMapDoesNotExist) {
            ...
            throw StoreOperationErrorHandler.onShardMapperErrorGlobal(result, shardMap, shard, errorCategory, this.getOperationName(),
