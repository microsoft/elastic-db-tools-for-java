...
public class AddShardingSchemaInfoGlobalOperation extends StoreOperationGlobal {
     ...
     *            Schema info to add.
     */
    public AddShardingSchemaInfoGlobalOperation(ShardMapManager shardMapManager,
    ...
    public void handleDoGlobalExecuteError(StoreResults result) {
        ...
        throw StoreOperationErrorHandler.onShardSchemaInfoErrorGlobal(result, schemaInfo.getName(), this.getOperationName(),
