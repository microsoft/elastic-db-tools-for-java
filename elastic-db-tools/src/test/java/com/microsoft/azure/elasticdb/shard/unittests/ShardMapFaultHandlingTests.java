...
public class ShardMapFaultHandlingTests {
    ...
    private static void cleanShardMapsHelper() {
        ...
        ListShardMap<Integer> lsm = smm.getListShardMap(ShardMapFaultHandlingTests.listShardMapName, ShardKeyType.Int32);
        assert lsm != null;
        ...
        RangeShardMap<Integer> rsm = smm.getRangeShardMap(ShardMapFaultHandlingTests.rangeShardMapName, ShardKeyType.Int32);
        assert rsm != null;
    ...
    public static void shardMapFaultHandlingTestsInitialize() {
        try (Connection conn = DriverManager.getConnection(Globals.SHARD_MAP_MANAGER_TEST_CONN_STRING)) {
            ...
            for (int i = 0; i < ShardMapFaultHandlingTests.shardDBs.length; i++) {
                try (Statement stmt = conn.createStatement()) {
                    String query = String.format(Globals.DROP_DATABASE_QUERY, ShardMapFaultHandlingTests.shardDBs[i]);
                    stmt.execute(query);
                }
                ...
                try (Statement stmt = conn.createStatement()) {
                    String query = String.format(Globals.CREATE_DATABASE_QUERY, ShardMapFaultHandlingTests.shardDBs[i]);
                    stmt.execute(query);
                }
                catch (SQLException e) {
                    e.printStackTrace();
        ...
        ListShardMap<Integer> lsm = smm.createListShardMap(ShardMapFaultHandlingTests.listShardMapName, ShardKeyType.Int32);
        ...
        RangeShardMap<Integer> rsm = smm.createRangeShardMap(ShardMapFaultHandlingTests.rangeShardMapName, ShardKeyType.Int32);
    ...
    public void addPointMappingFailGsmAfterSuccessLsmSingleRetry() {
        ...
        stubStoreOperationFactory.createAddMappingOperation4Param = (smm,
                opCode,
                ssm,
        ...
        Shard s = lsm.createShard(new ShardLocation(Globals.TEST_CONN_SERVER_NAME, ShardMapFaultHandlingTests.shardDBs[0]));
    ...
    public void addPointMappingFailGsmAfterSuccessLsm() {
        ...
        ssof.createAddMappingOperation4Param = (smm,
                opCode,
                ssm,
    ...
    public void addRangeMappingFailGsmAfterSuccessLsmSingleRetry() {
        ...
        Shard s = rsm.createShard(new ShardLocation(Globals.TEST_CONN_SERVER_NAME, ShardMapFaultHandlingTests.shardDBs[0]));
    ...
    public void shardMapOperationsFailureAfterGlobalPreLocal() {
        StubStoreOperationFactory ssof = new StubStoreOperationFactory();
        ssof.setCallBase(true);
        ssof.createAddShardOperationShardMapManagerIStoreShardMapIStoreShard = AddShardOperationFailAfterGlobalPreLocal::new;
        ssof.createRemoveShardOperationShardMapManagerIStoreShardMapIStoreShard = RemoveShardOperationFailAfterGlobalPreLocal::new;
        ...
        ssof.createReplaceMappingsOperation5Param = ReplaceMappingsOperationFailAfterGlobalPreLocal::new;
        ...
        Shard stemp = rsm.createShard(new ShardLocation(Globals.TEST_CONN_SERVER_NAME, ShardMapFaultHandlingTests.shardDBs[0]));
        ...
        Shard s1 = rsm.createShard(new ShardLocation(Globals.TEST_CONN_SERVER_NAME, ShardMapFaultHandlingTests.shardDBs[0]));

        assert s1 != null;

        Shard s2 = rsm.createShard(new ShardLocation(Globals.TEST_CONN_SERVER_NAME, ShardMapFaultHandlingTests.shardDBs[1]));
    ...
    public void shardMapOperationsFailureAfterLocalSource() {
        StubStoreOperationFactory ssof = new StubStoreOperationFactory();
        ssof.setCallBase(true);
        ssof.createAddShardOperationShardMapManagerIStoreShardMapIStoreShard = AddShardOperationFailAfterLocalSource::new;
        ssof.createRemoveShardOperationShardMapManagerIStoreShardMapIStoreShard = RemoveShardOperationFailAfterLocalSource::new;
        ...
        // global pre-local only create shard
        rsm.createShard(new ShardLocation(Globals.TEST_CONN_SERVER_NAME, ShardMapFaultHandlingTests.shardDBs[0]));
    ...
    public void shardMapOperationsFailureAfterLocalTarget() {
        StubStoreOperationFactory ssof = new StubStoreOperationFactory();
        ssof.setCallBase(true);
        ssof.createAddShardOperationShardMapManagerIStoreShardMapIStoreShard = AddShardOperationFailAfterLocalTarget::new;
        ssof.createRemoveShardOperationShardMapManagerIStoreShardMapIStoreShard = RemoveShardOperationFailAfterLocalTarget::new;
    ...
    private class NTimeFailingAddMappingOperation extends AddMappingOperation {
        ...
        public NTimeFailingAddMappingOperation(int failureCountMax,
