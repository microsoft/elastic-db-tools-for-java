...
public class StubICacheStoreMapping implements ICacheStoreMapping {
    ...
    public final long getCreationTime() {
        ...
        return this.getInstanceBehavior().<StubICacheStoreMapping, Long>result(this, "ICacheStoreMapping.get_CreationTime");
    }
    ...
    public StoreMapping getMapping() {
        ...
        return this.getInstanceBehavior().result(this, "ICacheStoreMapping.get_Mapping");
    }
    ...
    public long getTimeToLiveMilliseconds() {
        ...
        return this.getInstanceBehavior().<StubICacheStoreMapping, Long>result(this, "ICacheStoreMapping.get_TimeToLiveMilliseconds");
    }
    ...
    public final boolean hasTimeToLiveExpired() {
        ...
        return this.getInstanceBehavior().<StubICacheStoreMapping, Boolean>result(this, "ICacheStoreMapping.HasTimeToLiveExpired");
    }
