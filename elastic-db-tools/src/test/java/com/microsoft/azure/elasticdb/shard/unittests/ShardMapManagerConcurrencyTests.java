...
public class ShardMapManagerConcurrencyTests {
    ...
    public void concurrencyScenarioListShardMap() {
        ...
        ShardMapManager smmMgmt = ShardMapManagerFactory.getSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, ShardMapManagerLoadPolicy.Lazy);

        ShardMapManager smmClient = ShardMapManagerFactory.getSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING,
                ShardMapManagerLoadPolicy.Lazy);

        /// #region CreateShardMap

        // Add a shard map from management SMM.
        ShardMap smMgmt = smmMgmt.<Integer>createListShardMap(ShardMapManagerConcurrencyTests.s_shardMapName, ShardKeyType.Int32);
        ...
        ListShardMap<Integer> lsmMgmt = smmMgmt.getListShardMap(ShardMapManagerConcurrencyTests.s_shardMapName, ShardKeyType.Int32);
        assert lsmMgmt != null;

        // look up shard map again, it will
        ListShardMap<Integer> lsmClient = smmClient.getListShardMap(ShardMapManagerConcurrencyTests.s_shardMapName, ShardKeyType.Int32);
