...
public class AddShardMapGlobalOperation extends StoreOperationGlobal {
     ...
     *            Shard map to add.
     */
    public AddShardMapGlobalOperation(ShardMapManager shardMapManager,
    ...
    public StoreResults doGlobalExecute(IStoreTransactionScope ts) {
        return ts.executeOperation(StoreOperationRequestBuilder.SP_ADD_SHARD_MAP_GLOBAL, StoreOperationRequestBuilder.addShardMapGlobal(shardMap));
    }
