...
public class MappingComparisonResult {
     ...
     *
     * @param ssm
     *            Store representation of shard map.
     * @param range
     *            Range being considered.
     * @param mappingLocation
     *            Location of mapping.
     * @param gsmMapping
     *            Storage representation of GSM mapping.
     * @param lsmMapping
     *            Storage representation of LSM mapping.
     */
    public MappingComparisonResult(StoreShardMap ssm,
            ShardRange range,
            MappingLocation mappingLocation,
            StoreMapping gsmMapping,
            StoreMapping lsmMapping) {
