...
public class AddShardOperation extends StoreOperation {
     ...
     *            Shard to add.
     */
    public AddShardOperation(ShardMapManager shardMapManager,
    ...
    public StoreConnectionInfo getStoreConnectionInfo() {
        ...
        ShardLocation location = this.getUndoStartState().getValue() <= StoreOperationState.UndoLocalSourceBeginTransaction.getValue()
                ? shard.getLocation()
                : null;
