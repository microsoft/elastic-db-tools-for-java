...
public class FindMappingByIdGlobalOperation extends StoreOperationGlobal {
     ...
     *            Error category.
     */
    public FindMappingByIdGlobalOperation(ShardMapManager shardMapManager,
    ...
    public void handleDoGlobalExecuteError(StoreResults result) {
        ...
        throw StoreOperationErrorHandler.onShardMapperErrorGlobal(result, shardMap, mapping.getStoreShard(), errorCategory, this.getOperationName(),
