...
public interface IStoreOperationFactory {
     ...
     */
    IStoreOperationGlobal createCreateShardMapManagerGlobalOperation(SqlShardMapManagerCredentials credentials,
     ...
     * @return The store operation.
     */
    IStoreOperationGlobal createGetShardMapManagerGlobalOperation(SqlShardMapManagerCredentials credentials,
            RetryPolicy retryPolicy,
            String operationName,
     ...
     * @return The store operation.
     */
    IStoreOperationGlobal createRemoveShardingSchemaInfoGlobalOperation(ShardMapManager shardMapManager,
            String operationName,
            String schemaInfoName);
     ...
     * @return The store operation.
     */
    IStoreOperationGlobal createUpdateShardingSchemaInfoGlobalOperation(ShardMapManager shardMapManager,
            String operationName,
            StoreSchemaInfo schemaInfo);
     ...
     * @return The store operation.
     */
    IStoreOperationGlobal createGetDistinctShardLocationsGlobalOperation(ShardMapManager shardMapManager,
            String operationName);
     ...
     * @return The store operation.
     */
    IStoreOperation createAddShardOperation(ShardMapManager shardMapManager,
            StoreShardMap shardMap,
            StoreShard shard);
     ...
     * @param root
     *            Xml representation of the object.
     * @param shardIdOriginalSource
     *            Original shard Id of source.
     * @param shardIdOriginalTarget
     *            Original shard Id of target.
     * @return The store operation.
     */
    IStoreOperation createUpdateMappingOperation(StoreOperationCode operationCode,
            ...
            StoreOperationState undoStartState,
            Element root,
            UUID shardIdOriginalSource,
            UUID shardIdOriginalTarget);
     ...
     * @return The store operation.
     */
    IStoreOperation fromLogEntry(ShardMapManager shardMapManager,
            StoreLogEntry so);
