...
public class StoreOperationErrorHandler {
    ...
    /**
     * Returns the proper ShardManagementException corresponding to given error code in <paramref name="result"/> for ShardMapManager operations.
     *
     * @param result
    ...
    public static ShardManagementException onShardMapManagerErrorGlobal(StoreResults result,
        ...
        switch (result.getResult()) {
            case ShardMapExists:
                ...
                return new ShardManagementException(ShardManagementErrorCategory.ShardMapManager, ShardManagementErrorCode.ShardMapAlreadyExists,
                        Errors._Store_ShardMap_AlreadyExistsGlobal, shardMap.getName(), storedProcName, operationName);

            case ShardMapHasShards:
                assert shardMap != null;
                return new ShardManagementException(ShardManagementErrorCategory.ShardMapManager, ShardManagementErrorCode.ShardMapHasShards,
                        Errors._Store_ShardMap_ContainsShardsGlobal, shardMap.getName(), storedProcName, operationName);
    ...
    /**
     * Returns the proper ShardManagementException corresponding to given error code in <paramref name="result"/> for ShardMap operations.
     *
     * @param result
     *            Operation result object.
     * @param shardMap
     ...
     *            Shard object.
     * @param errorCategory
     *            Error category to use for raised errors.
     * @param operationName
     *            Operation being performed.
     * @param storedProcName
     *            Stored procedure being executed.
    ...
    public static ShardManagementException onShardMapErrorGlobal(StoreResults result,
        ...
        switch (result.getResult()) {
            ...
            case ShardExists:
                return new ShardManagementException(errorCategory, ShardManagementErrorCode.ShardAlreadyExists,
                        Errors._Store_Shard_AlreadyExistsGlobal, shard.getLocation(), shardMap.getName(), storedProcName, operationName);

            case ShardLocationExists:
                return new ShardManagementException(errorCategory, ShardManagementErrorCode.ShardLocationAlreadyExists,
                        Errors._Store_Shard_LocationAlreadyExistsGlobal, shard.getLocation(), shardMap.getName(), storedProcName, operationName);
            ...
            case ShardHasMappings:
                return new ShardManagementException(errorCategory, ShardManagementErrorCode.ShardHasMappings, Errors._Store_Shard_HasMappingsGlobal,
                        shard.getLocation(), shardMap.getName(), storedProcName, operationName);
    ...
    public static ShardManagementException onShardMapErrorLocal(StoreResults result,
        ...
        switch (result.getResult()) {
            case UnableToKillSessions:
                return new ShardManagementException(errorCategory, ShardManagementErrorCode.MappingsKillConnectionFailure,
                        Errors._Store_ShardMapper_UnableToKillSessions, location, shardMap.getName(), operationName, storedProcName, location);
            ...
            case ShardDoesNotExist:
                ...
                return new ShardManagementException(ShardManagementErrorCategory.Recovery, ShardManagementErrorCode.ShardDoesNotExist,
                        Errors._Store_Validate_ShardDoesNotExist, location, shardMap.getName(), operationName, storedProcName);
            default:
    ...
    /**
     * Returns the proper ShardManagementException corresponding to given error code in <paramref name="result"/> for ShardMapper operations.
     *
     * @param result
     *            Operation result object.
     * @param shardMap
    ...
    public static ShardManagementException onValidationErrorLocal(StoreResults result,
        ...
        switch (result.getResult()) {
            case ShardMapDoesNotExist:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.ShardMapDoesNotExist,
                        Errors._Store_Validate_ShardMapDoesNotExist, shardMap.getName(), location, operationName, storedProcName);

            case ShardDoesNotExist:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.ShardDoesNotExist,
                        Errors._Store_Validate_ShardDoesNotExist, location, shardMap.getName(), operationName, storedProcName);

            case ShardVersionMismatch:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.ShardVersionMismatch,
                        Errors._Store_Validate_ShardVersionMismatch, location, shardMap.getName(), operationName, storedProcName);

            case MappingDoesNotExist:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.MappingDoesNotExist,
                        Errors._Store_Validate_MappingDoesNotExist, location, shardMap.getName(), operationName, storedProcName);

            case MappingIsOffline:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.MappingIsOffline,
                        Errors._Store_Validate_MappingIsOffline, location, shardMap.getName(), operationName, storedProcName);
    ...
    public static ShardManagementException onShardSchemaInfoErrorGlobal(StoreResults result,
        ...
        switch (result.getResult()) {
            ...
            case SchemaInfoNameDoesNotExist:
                throw new SchemaInfoException(SchemaInfoErrorCode.SchemaInfoNameDoesNotExist, Errors._Store_SchemaInfo_NameDoesNotExist,
    ...
    public static ShardManagementException onRecoveryErrorGlobal(StoreResults result,
        ...
        switch (result.getResult()) {
            ...
            case ShardMapExists:
                assert shardMap != null;
                return new ShardManagementException(errorCategory, ShardManagementErrorCode.ShardMapAlreadyExists,
                        Errors._Store_ShardMap_AlreadyExistsGlobal, shardMap.getName(), storedProcName, operationName);
    ...
    public static ShardManagementException onRecoveryErrorLocal(StoreResults result,
        ...
        switch (result.getResult()) {
            case ShardMapDoesNotExist:
                return new ShardManagementException(errorCategory, ShardManagementErrorCode.ShardMapDoesNotExist,
                        Errors._Store_ShardMap_DoesNotExistLocal, shardMap.getName(), location, storedProcName, operationName);
    ...
    /**
     * Returns the proper ShardManagementException corresponding to given common error code in <paramref name="result"/>.
     *
     * @param result
     *            Operation result object.
     * @param operationName
    ...
    public static ShardManagementException onCommonErrorGlobal(StoreResults result,
        ...
        switch (result.getResult()) {
            case StoreVersionMismatch:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.GlobalStoreVersionMismatch,
                        Errors._Store_UnsupportedLibraryVersionGlobal, (result.getStoreVersion() != null) ? result.getStoreVersion().toString() : "",
                        GlobalConstants.GsmVersionClient,
                        (result.getStoreVersion() != null)
                                ? (Version.isFirstGreaterThan(result.getStoreVersion(), GlobalConstants.GsmVersionClient) ? "library" : "store")
                                : "store");

            case MissingParametersForStoredProcedure:
                return new ShardManagementException(ShardManagementErrorCategory.Validation,
                        ShardManagementErrorCode.GlobalStoreOperationInsufficientParameters, Errors._Store_MissingSprocParametersGlobal,
                        operationName, storedProcName);

            default:
                // Debug.Fail("Unexpected error code found.");
                return new ShardManagementException(ShardManagementErrorCategory.General, ShardManagementErrorCode.UnexpectedError,
    ...
    private static ShardManagementException onCommonErrorLocal(StoreResults result,
        ...
        switch (result.getResult()) {
            case StoreVersionMismatch:
                return new ShardManagementException(ShardManagementErrorCategory.Validation, ShardManagementErrorCode.LocalStoreVersionMismatch,
                        Errors._Store_UnsupportedLibraryVersionLocal, (result.getStoreVersion() != null) ? result.getStoreVersion().toString() : "",
                        location, GlobalConstants.LsmVersionClient,
                        (result.getStoreVersion() != null)
                                ? (Version.isFirstGreaterThan(result.getStoreVersion(), GlobalConstants.LsmVersionClient) ? "library" : "store")
                                : "store");

            case MissingParametersForStoredProcedure:
                return new ShardManagementException(ShardManagementErrorCategory.Validation,
                        ShardManagementErrorCode.LocalStoreOperationInsufficientParameters, Errors._Store_MissingSprocParametersLocal, operationName,
                        location, storedProcName);

            default:
                // Debug.Fail("Unexpected error code found.");
                return new ShardManagementException(ShardManagementErrorCategory.General, ShardManagementErrorCode.UnexpectedError,
                        Errors._Store_UnexpectedErrorLocal, location);
        }
    }
