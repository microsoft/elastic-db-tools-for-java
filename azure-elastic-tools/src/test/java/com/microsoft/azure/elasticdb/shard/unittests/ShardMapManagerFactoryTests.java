...
public class ShardMapManagerFactoryTests {
    ...
    public void getShardMapManager_Success() {
        ...
        for (ShardMapManagerLoadPolicy policy : ShardMapManagerLoadPolicy.values()) {
            ShardMapManager smm1 = ShardMapManagerFactory.getSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, policy);
            assertNotNull(smm1);

            ShardMapManager smm2 = ShardMapManagerFactory.getSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, policy,
    ...
    public void tryGetShardMapManager_Success() {
        ...
        for (ShardMapManagerLoadPolicy policy : ShardMapManagerLoadPolicy.values()) {
            ...
            success = ShardMapManagerFactory.tryGetSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, policy, smmref);
            assertTrue(success);
            assertNotNull(smmref.argValue);

            success = ShardMapManagerFactory.tryGetSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, policy,
    ...
    public void tryGetShardMapManager_Fail() {
        ...
        try {
            success = ShardMapManagerFactory.tryGetSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, ShardMapManagerLoadPolicy.Eager, null,
                    smmref);
        }
    ...
    public void createShardMapManager_NoOverwrite() {
        ShardMapManagerFactory.createSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, ShardMapManagerCreateMode.ReplaceExisting);
        try {
            ShardMapManagerFactory.createSqlShardMapManager(Globals.SHARD_MAP_MANAGER_CONN_STRING, ShardMapManagerCreateMode.KeepExisting);
        }
