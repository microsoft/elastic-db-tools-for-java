...
/**
 * Stub type of UpdateShardOperation.
 */
public class StubUpdateShardOperation extends UpdateShardOperation {
    ...
    /**
     * Sets the stub of UpdateShardOperation.handleDoGlobalPostLocalExecuteError(StoreResults result)
     */
    public Action1Param<StoreResults> handleDoGlobalPostLocalExecuteErrorIStoreResults;
    /**
     * Sets the stub of UpdateShardOperation.handleDoGlobalPreLocalExecuteError(StoreResults result)
     */
    public Action1Param<StoreResults> handleDoGlobalPreLocalExecuteErrorIStoreResults;
    /**
     * Sets the stub of UpdateShardOperation.handleDoLocalSourceExecuteError(StoreResults result)
     */
    ...
    /**
     * Sets the stub of UpdateShardOperation.handleUndoGlobalPostLocalExecuteError(StoreResults result)
     */
    ...
    /**
     * Sets the stub of UpdateShardOperation.handleUndoLocalSourceExecuteError(StoreResults result)
     */
     ...
     */
    public StubUpdateShardOperation(ShardMapManager shardMapManager,
