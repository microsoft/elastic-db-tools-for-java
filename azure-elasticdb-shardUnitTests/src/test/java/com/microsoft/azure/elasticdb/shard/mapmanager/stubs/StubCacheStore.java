...
import com.microsoft.azure.elasticdb.shard.mapmanager.stubhelper.Action0Param;
import com.microsoft.azure.elasticdb.shard.mapmanager.stubhelper.Action1Param;
import com.microsoft.azure.elasticdb.shard.mapmanager.stubhelper.Action2Param;
...
public class StubCacheStore extends CacheStore {
  ...
  public void addOrUpdateShardMap(StoreShardMap shardMap) {
    Action1Param<StoreShardMap> action1 = (StoreShardMap obj) -> AddOrUpdateShardMapIStoreShardMap
        .invoke(obj);
    if (action1 != null) {
