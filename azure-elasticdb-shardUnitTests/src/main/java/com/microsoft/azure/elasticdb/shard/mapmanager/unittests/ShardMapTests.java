...
import com.microsoft.azure.elasticdb.shard.mapmanager.stubs.StubAddShardOperation;
import com.microsoft.azure.elasticdb.shard.mapmanager.stubs.StubRemoveShardOperation;
import com.microsoft.azure.elasticdb.shard.mapmanager.stubs.StubStoreOperationFactory;
import com.microsoft.azure.elasticdb.shard.mapmanager.stubs.StubUpdateShardOperation;
...
public class ShardMapTests {
  ...
  public void deleteShardAbortGSMDoAndLSMUndo() {
    ...
    // TODO Object pendingOperations = ShardMapperTests.GetPendingStoreOperations();
    // assert pendingOperations.Count() == 1;
...
@FunctionalInterface
interface EventHandler<T extends EventArgs> {
