...
public class TraceSource {
    ...
    public void TraceEvent(TraceEventType eventType, int i, String s, String message, RuntimeException exception) {
    }

    public void TraceEvent(TraceEventType eventType, int i, String s, String message, UUID activityId) {
    }

    public void TraceEvent(TraceEventType start, int i, String s, String method, String fmtMessage, UUID activityId) {
    }
}
