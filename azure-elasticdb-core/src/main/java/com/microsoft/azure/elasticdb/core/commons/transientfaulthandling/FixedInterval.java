...
public class FixedInterval extends RetryStrategy {
  ...
  /**
   * Initializes a new instance of the <see cref="FixedInterval"/> class with the specified number
   * of retry attempts.
   *
  ...
  /**
   * Initializes a new instance of the <see cref="FixedInterval"/> class with the specified number
   * of retry attempts and time interval.
   *
   * @param retryCount The number of retry attempts.
  ...
  /**
   * Initializes a new instance of the <see cref="FixedInterval"/> class with the specified number
   * of retry attempts, time interval, and retry strategy.
   *
  ...
  /**
   * Initializes a new instance of the <see cref="FixedInterval"/> class with the specified number
   * of retry attempts, time interval, retry strategy, and fast start option.
   *
   * @param name The retry strategy name.
   * @param retryCount The number of retry attempts.
   * @param retryInterval The time interval between retries.
