...
public final class TraceHelper {
    ...
    public static void TraceWarning(ILogger logger, String methodName, String message, Object... vars) {
        String fmtMessage = String.format(message, vars);
        logger.Warning("Method: {0}; {1}; ActivityId: {2};", methodName, fmtMessage, Trace.CorrelationManager.ActivityId);
    }

    public static void TraceError(ILogger logger, String methodName, RuntimeException ex, String message, Object... vars) {
        String fmtMessage = String.format(message, vars);
        logger.Error("Method: {0}; {1}; Exception: {2}; ActivityId: {3};", methodName, fmtMessage, ex.toString(), Trace.CorrelationManager.ActivityId);
    }
     ...
     * @param vars          The args
     */
    public static void TraceVerbose(ILogger logger, String componentName, String methodName, String message, Object... vars) {
        String fmtMessage = String.format(message, vars);
     ...
     * @param vars          The args
     */
    public static void TraceInfo(ILogger logger, String componentName, String methodName, String message, Object... vars) {
        String fmtMessage = String.format(message, vars);
     ...
     * @param vars          The args
     */
    public static void TraceWarning(ILogger logger, String componentName, String methodName, String message, Object... vars) {
        String fmtMessage = String.format(message, vars);
     ...
     * @param vars          The args
     */
    public static void TraceError(ILogger logger, String componentName, String methodName, String message, Object... vars) {
        String fmtMessage = String.format(message, vars);
