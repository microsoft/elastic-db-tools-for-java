...
public class TraceSourceWrapper implements ILogger {
  ...
  public final void Warning(RuntimeException exception, String message) {
    _traceSource.TraceEvent(TraceEventType.Warning, 0, "{0}. Encountered exception: {1}", message,
        exception);
  }
  ...
  public final void Warning(RuntimeException exception, String format, Object... vars) {
    ...
    _traceSource
        .TraceEvent(TraceEventType.Warning, 0, "{0}. Encountered exception: {1}", fmtMessage,
            exception);
  }
  ...
  public final void Error(RuntimeException exception, String message) {
    _traceSource
        .TraceEvent(TraceEventType.Error, 0, "{0}. Encountered exception: {1}", message, exception);
  }
  ...
  public final void Error(RuntimeException exception, String format, Object... vars) {
    String fmtMessage = String.format(format, vars);
    _traceSource.TraceEvent(TraceEventType.Error, 0, "{0}. Encountered exception: {1}", fmtMessage,
        exception);
  }
  ...
  public final void Critical(RuntimeException exception, String message) {
    _traceSource.TraceEvent(TraceEventType.Critical, 0, "{0}. Exception encountered: {1}", message,
        exception);
  }
  ...
  public final void Critical(RuntimeException exception, String format, Object... vars) {
    String fmtMessage = String.format(format, vars);
    _traceSource
        .TraceEvent(TraceEventType.Critical, 0, "{0}. Exception encountered: {1}", fmtMessage,
            exception);
  }
  ...
  public final void TraceIn(String method, UUID activityId) {
    _traceSource
        .TraceEvent(TraceEventType.Start, 0, "Start.{0}. ActivityId: {1}", method, activityId);
  }
  ...
  public final void TraceOut(String method, UUID activityId) {
    _traceSource
        .TraceEvent(TraceEventType.Stop, 0, "Stop.{0}. ActivityId: {1}", method, activityId);
  }
  ...
  public final void TraceIn(String method, UUID activityId, String format, Object... vars) {
    String fmtMessage = String.format(format, vars);
    _traceSource
        .TraceEvent(TraceEventType.Start, 0, "Start.{0}. {1}. ActivityId: {2}", method, fmtMessage,
            activityId);
  }
  ...
  public final void TraceOut(String method, UUID activityId, String format, Object... vars) {
    String fmtMessage = String.format(format, vars);
    _traceSource
        .TraceEvent(TraceEventType.Stop, 0, "Stop.{0}. {1}. ActivityId: {2}", method, fmtMessage,
            activityId);
  }
  ...
  @Override
  public void TraceVerbose(String shardMapManager, String onAddOrUpdateShardMap, String s,
      String name) {
  ...
  @Override
  public void TraceVerbose(String shardMapManager, String lookupShardMapByNameInCache, String s,
      String s1, String shardMapName) {
