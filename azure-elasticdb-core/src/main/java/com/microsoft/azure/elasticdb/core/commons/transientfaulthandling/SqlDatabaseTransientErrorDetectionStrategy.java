...
/**
 * Provides the transient error detection logic for transient faults that are specific to SQL
 * Database.
 */
public final class SqlDatabaseTransientErrorDetectionStrategy implements
  ...
  //TODO TASK: There is no equivalent to implicit typing in Java:
            ...
            sqlException.Data[condition.ThrottlingMode.getClass().getSimpleName()]
        ...
        /*Win32Exception wex = (Win32Exception) ((sqlException.getCause() instanceof Win32Exception)
