...
public class Program {
    ...
    private static void createShardMapManagerAndShard() {
        ...
        if (!SqlDatabaseUtils.databaseExists(shardMapManagerServerName, shardMapManagerDatabaseName)) {
            shardMapManagerConnectionString = SqlDatabaseUtils.createDatabase(shardMapManagerServerName, shardMapManagerDatabaseName);
        }
        else {
            shardMapManagerConnectionString = Configuration.getConnectionString(shardMapManagerServerName, shardMapManagerDatabaseName);
        }
